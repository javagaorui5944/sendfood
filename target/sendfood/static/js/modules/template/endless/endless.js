define(['lib/jquery',
        'modules/template/uncompressed/modernizr',
        'modules/template/uncompressed/pace',
        'modules/template/uncompressed/jquery.slimscroll',
        'modules/template/uncompressed/jquery.cookie',
        'modules/template/uncompressed/jquery.popupoverlay'],function($,modernizr,pace){


	// Cookie validation
	if($.type($.cookie('skin_color')) != 'undefined')	{
